      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #142640, #0a1628)' }}
          >
            <span className="text-2xl font-bold tracking-tight text-white">LLM</span>
          </div>
          <h1 className="text-3xl font-bold text-text-primary tracking-tight">SDM LLM Gateway</h1>
