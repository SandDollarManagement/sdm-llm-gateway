            ...
            {logs.length === 0 && (
              <tr>
                <td colSpan={9} className="px-4 py-8 text-center text-muted text-sm">
                  No log entries match the current filters. Make a call to{' '}
                  <code>/v1/chat/completions</code> to populate.
                </td>
              </tr>
            )}
            {logs.map((l) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-2.5">
                    <code className="text-xs">{l.alias || '—'}</code>
                  </td>
